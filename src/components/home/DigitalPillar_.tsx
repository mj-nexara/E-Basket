  ...
  const products = [
    {
      id: 'dp001',
      title: 'Nexascend CLI',
      description: 'Advanced command-line interface for next-generation development workflows. Features integrated AI assistance, modular plugins, and seamless CI/CD integration.',
      image: nexascendcli,
    },
    {
      id: 'dp002',
      title: 'Nex API',
      description: 'A secure, scalable API framework designed for ethical data exchange and modular commerce.',
      image: NexAPI,
    },
    {
      id: 'dp003',
      title: 'Nex SDLC',
      description: 'Structured development lifecycle tools for ethical software creation.',
      image: NexSDLC,
    },
    {
      id: 'dp004',
      title: 'Nex OSS',
      description: 'Open-source software suite supporting community-driven innovation.',
      image: NexOSS,
    },
  ];
